...
- **Drug interaction checker for pharmacies**:
    ...
    - It is capable of flagging drugs which are not covered under the patient's insurance plan
    - It is capable of suggesting alternative drugs which are relevant w.r.t. both the patient's prescription and with insurance policies
...
- **knights-and-chivalry** *(March 2025 - Present)*
  - An AI-agent based workflow using Langgraph/Langchain for performing a research around a topic on the web
  - **Technologies used**: Python, Langchain, Langgraph
