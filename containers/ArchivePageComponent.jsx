...
function ArchivePageComponent(props) {
  ...
  return (
    <div className="w-full border bg-black bg-opacity-75 border-green-400 border-opacity-50 px-16 py-4">
      <div className="text-5xl font-semibold w-full border-green-400 border-opacity-50 border-b py-3 px-4 text-center">Posts</div>
      {
